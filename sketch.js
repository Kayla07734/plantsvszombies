...
function preload(){
  ...
  zombiedeadImg = loadImage("assets/zombiefly.png")

  bgImg = loadImage("assets/bg.jpeg")
  xplo = loadSound("assets/explosion.mp3")
  winner = loadSound("assets/win.mp3")
  loss = loadSound("assets/lose.mp3")
...
if(zombieGroup.isTouching(bulletGroup)){
  for(var i=0;i<zombieGroup.length;i++){     
   ...
   if(zombieGroup.isTouching(bulletGroup)){
         var dead = createSprite(zombieGroup[i].x,zombieGroup[i].y,50,50)
         dead.addImage(zombiedeadImg)
         dead.scale= 0.3
         dead.velocityY= -2
         dead.life=100
         xplo.play()
...
function bats(){
  if(frameCount%100===0){
    ...
    bat=createSprite(2000,random(50,100),40,40)
